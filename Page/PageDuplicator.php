...
namespace Ok99\PrivateZoneCore\PageBundle\Page;
...
use Ok99\PrivateZoneCore\PageBundle\Entity\BlockTranslation;
 ...
 * @package Ok99\PrivateZoneCore\PageBundle\Page
 */
class PageDuplicator
{
    ...
    {
        $page = $this->entityManager->getRepository('Ok99\PrivateZoneCore\PageBundle\Entity\Page')->findOneById($id);
