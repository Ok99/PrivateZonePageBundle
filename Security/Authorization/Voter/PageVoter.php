...
class PageVoter implements VoterInterface
{
    ...
    const PAGE_CLASS = 'Ok99\PrivateZoneCore\PageBundle\Entity\Page';
    const PAGE_ADMIN_CLASS = 'Ok99\PrivateZoneCore\PageBundle\Admin\PageAdmin';
    const PROXY_PAGE_CLASS = 'Proxies\__CG__\Ok99\PrivateZoneCore\PageBundle\Entity\Page';
