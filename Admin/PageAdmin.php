    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ->with($this->trans('form_page.group_settings_label'))
                ...
                ->add('parent', 'ok99_privatezone_page_selector', array(
                ...
                ->add('target', 'ok99_privatezone_page_selector', array(
                    'page'          => $this->getSubject() ?: null,
                    'site'          => $site,
                    'model_manager' => $this->getModelManager(),
                    'class'         => $this->getClass(),
...
*/
    ...
    protected function configureSideMenu(MenuItemInterface $menu, $action, AdminInterface $childAdmin = null)
    {
        ...
        if ($this->securityHandler->isGranted($this->getChild('sonata.page.admin.snapshot'), 'EDIT', $this->getChild('sonata.page.admin.snapshot'))) {
            $menu->addChild(
                ...
                array('uri' => $admin->generateUrl('sonata.page.admin.snapshot.list', array('id' => $id)), 'attributes' => array('class' => $admin->getRequest()->get('_route') == 'admin_privatezonecore_page_page_snapshot_list' ? 'active' : ''))
            );
        }
    }
    ...
    {
		return $this->getConfigurationPool()->getContainer()->getParameter('ok99.privatezone.locales');
    }
